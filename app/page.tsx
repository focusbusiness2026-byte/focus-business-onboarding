...
export default function Home() {
  ...
  const validate = (index: number) => {
    ...
    if (index === 2 && asArray(data.channels).includes("Landing pages")) {
      if (!String(data.landingCopyOwner || "").trim()) errors.landingCopyOwner = "Indica quién será responsable del copy de las landings.";
      if (!String(data.landingCopyBrief || "").trim()) errors.landingCopyBrief = "Pega el copy o indica referencias y la llamada a la acción.";
    }
