...
const requiredByStep = [
  ["companyName","legalName","website","activity","location","teamSize","description","driveAssetsUrl","brandPrimaryColor","brandSecondaryColor","headingFont","bodyFont","brandColor","logoUrl","formality"],
