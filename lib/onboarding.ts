...
export const sheetHeaders = [
  ...
  "Recursos Drive", "Color corporativo primario", "Color corporativo secundario", "Tercer color corporativo", "Tipografía títulos", "Tipografía textos", "Preguntas adicionales", "Objetivo campaña", "Conversión campaña", "Público campaña", "Destino campaña", "Objetivo landing", "Contenido landing", "Uso VSL", "Enlace VSL", "Indicaciones VSL", "Herramientas actuales", "Herramientas a conectar",
...
export function toSheetRecord(row: StoredSubmission): Record<string, string> {
  ...
  return {
    ...
    "Recursos Drive": text(data.driveAssetsUrl), "Color corporativo primario": text(data.brandPrimaryColor || data.brandColor), "Color corporativo secundario": text(data.brandSecondaryColor), "Tercer color corporativo": text(data.brandAccentColor), "Tipografía títulos": text(data.headingFont), "Tipografía textos": text(data.bodyFont), "Preguntas adicionales": text(data.additionalLeadQuestions), "Objetivo campaña": text(data.campaignObjective), "Conversión campaña": text(data.campaignConversion), "Público campaña": text(data.campaignAudience), "Destino campaña": text(data.campaignDestination), "Objetivo landing": text(data.landingGoal), "Contenido landing": text(data.landingSections), "Uso VSL": text(data.landingVslChoice), "Enlace VSL": text(data.landingVslUrl), "Indicaciones VSL": text(data.landingVslNotes), "Herramientas actuales": text(data.toolsInUse), "Herramientas a conectar": text(data.toolsToConnect),
    ...
    "Configuración subdominio": text(data.subdomainSetup), "Uso del subdominio": text(data.subdomainPurpose), "Subdominio preferido": text(data.subdomainPreferred), "Subdominio alternativo": text(data.subdomainAlternative), "Propiedad del dominio": text(data.subdomainOwnership), "Estado acceso DNS": text(data.subdomainDnsStatus), "Verificación subdominio": text(data.subdomainVerification),
  };
}
