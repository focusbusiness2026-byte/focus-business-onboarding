...
Seguir `INTEGRACIONES.md` y completar las variables del archivo `.env`. El formulario funciona visualmente sin ellas, pero no envía datos a servicios externos hasta configurarlas.
